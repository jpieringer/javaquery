...
public class ConstructorWithVarargsParameterTest {
    @Test
    void verifyConstructorIsDetected() throws URISyntaxException {
        ...
        final Set<Object> actualElements = AnalyzerTestRunner.analyzeClassesOfTest(ConstructorWithVarargsParameterTest.class);
