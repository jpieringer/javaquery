...
public class MethodWithUnresolvedExplicitlyImportedReferenceParameterTest {
    @Test
    void verifyMethodIsDetected() throws URISyntaxException {
        ...
        final Set<Object> actualElements = AnalyzerTestRunner.analyzeClassesOfTest(MethodWithUnresolvedExplicitlyImportedReferenceParameterTest.class);
