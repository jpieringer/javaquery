...
public class CreateInstanceWithReferenceParameterTest {
    @Test
    void verifyCreateInstanceIsDetected() throws URISyntaxException {
        ...
        final Set<Object> actualElements = AnalyzerTestRunner.analyzeClassesOfTest(CreateInstanceWithReferenceParameterTest.class);
